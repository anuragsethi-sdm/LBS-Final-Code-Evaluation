...
st.set_page_config(page_title="NER", layout="centered")
st.title("Named Entity Recognition (NER) for News Articles")
st.markdown("Enter a sentence :")

sentence = st.text_input("Input Sentence:", "AI/ML is trending Now.")
